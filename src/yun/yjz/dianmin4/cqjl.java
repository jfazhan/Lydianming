...
public class cqjl extends Activity {
		...
		handler=new Handler(){
			public void handleMessage(Message msg) {
		        	...
		        	case 0:
		        			...
		        			banji=cqjl.this.openOrCreateDatabase("banji.db", MODE_PRIVATE,null);
		        	        classid=new HashMap<String,Object>(50);
		        	        for(int i=0;i<50;i++){
		        	        	String cmd="SELECT sName FROM"+" class"+i;
		        				String cmd1="SELECT Mac FROM"+" class"+i;
    ...
    private Dialog buildDialog1(Context context) {//…æ≥˝∞‡º∂
        ...
        builder.setPositiveButton(R.string.qr, new DialogInterface.OnClickListener(){
			...
			public void onClick(DialogInterface dialog, int which) {
				banji=cqjl.this.openOrCreateDatabase("banji.db", MODE_PRIVATE, null);
				chuqin=cqjl.this.openOrCreateDatabase("chuqin.db", MODE_PRIVATE, null);
				...
				chuqin.execSQL(cmd2);
				Toast.makeText(cqjl.this,R.string.scwc,Toast.LENGTH_SHORT ).show();
				banji.close();
				chuqin.close();
    ...
    private class bjmlListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				long arg3) {
			Intent intent1=new Intent("yun.yjz.dianmin4.cqjl");
			intent1.putExtra("cqjlclassid", classid.get(classname.get(arg2))+"");
			intent1.putExtra("cqjlclassname", classname.get(arg2));
			sendBroadcast(intent1);
			intent1.setClass(cqjl.this, cqjl2.class);
